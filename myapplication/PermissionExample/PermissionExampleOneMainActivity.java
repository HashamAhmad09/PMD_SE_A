...
public class PermissionExampleOneMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_permission_example_one_main2);
    ...
    public void Request_Permission()
    {
        ActivityCompat.requestPermissions(this,
                new String[]{ACCESS_FINE_LOCATION,CAMERA},101);
    ...
    public void CheckPermission(View view) {
        if(Check_Permission())
        {
            ...
            Toast.makeText(this, " Check Permission Already Granted", Toast.LENGTH_SHORT).show();
        }
